...
class PosttestService {
    ...
    post(requestBody, publisherDomain) {
        var url = "https://" + publisherDomain + ".audienceplay.com/storeAppEvents";
        return this.http.post(url, requestBody);
    }
}
PosttestService.ɵprov = ɵɵdefineInjectable({ factory: function PosttestService_Factory() { return new PosttestService(ɵɵinject(HttpClient)); }, token: PosttestService, providedIn: "root" });
PosttestService.decorators = [
    { type: Injectable, args: [{
                providedIn: 'root'
            },] }
];
PosttestService.ctorParameters = () => [
    { type: HttpClient }
];
...
export { PosttestComponent, PosttestModule, PosttestService };
